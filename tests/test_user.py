#!/usr/bin/python3
"""Definitions of testing for models/user.py.
...
class TestUser_instantiation(unittest.TestCase):
    """the testing of  instantiation of the User class."""
...
class TestUser_save(unittest.TestCase):
    """the testing function or save method of the  class."""
...
class TestUser_to_dict(unittest.TestCase):
    """the testing of the to_dict method of the User class."""
